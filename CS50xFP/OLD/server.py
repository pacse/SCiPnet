'''
THIS MODULE IS DEPRECETED AND WILL BE REMOVED IN FUTURE UPDATES.
IT CONTAINS OLDER VERSIONS OF FUNCTIONS FOUND IN `server/` THAT **DO NOT WORK**

Server side utility functions

Contains
--------
- create(client: socket.socket, f_type: str, thread_id: int, usr: User) -> None
'''
